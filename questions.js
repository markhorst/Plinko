const rules = [
    ...
    { id: 8, text: "Is it a custom job that runs PowerShell?", yes: { type: 'end', result: 'Non-SAAS server', isSaas: false }, no: { type: 'next', step: 9 } },
    { id: 9, text: "Is it a job that updates data in J1PRD, PFAIDS, and/or ICS_NET?", yes: { type: 'end', result: 'J1 SAAS SQL Server', isSaas: true }, no: { type: 'next', step: 0 } }
];